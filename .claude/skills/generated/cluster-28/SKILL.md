---
name: cluster-28
description: "Skill for the Cluster_28 area of butler. 6 symbols across 1 files."
---
...
- **`onSuccess`** (Function) — `src/lib/udp_queue_manager.js:621`
- **`reserveExecutionId`** (Method) — `src/lib/udp_queue_manager.js:417`
- **`markExecutionIdProcessed`** (Method) — `src/lib/udp_queue_manager.js:428`
