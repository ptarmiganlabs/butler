...
1. First version of **telemetry** added to Butler ([#142](https://github.com/ptarmiganlabs/butler/issues/142)).  
   More info [here](/docs/about/telemetry).

### Fixes and patches

1. Fixed bug [#143](https://github.com/ptarmiganlabs/butler/issues/143).
2. Show high level system info when starting Butler ([#140](https://github.com/ptarmiganlabs/butler/issues/140)).
3. Don't waste memory when MQTT is not used: Fixed [#139](https://github.com/ptarmiganlabs/butler/issues/139).
