...
module.exports.respondSenseAppDump = function (req, res, next) {
    ...
    session
        ...
        .then(global => {
            ...
            global
                ...
                .catch(function (error) {
                    globals.logger.error(
                        `Error while opening doc during app dump: ${JSON.stringify(error, null, 2)}`,
                    );
        ...
        .catch(function (error) {
            globals.logger.error(
                `Error while opening session to Sense engine during app dump: ${JSON.stringify(
          error,
          null,
          2,
        )}`,
