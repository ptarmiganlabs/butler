...
This project is indexed by GitNexus as **butler** (2757 symbols, 5524 relationships, 231 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
