...
Disabling deduplication is useful when you want Butler to process every scheduler UDP message exactly as received, even if Qlik Sense emits duplicate execution IDs. That is a deliberate tradeoff: you get full message replay at the cost of duplicate downstream notifications or actions.
